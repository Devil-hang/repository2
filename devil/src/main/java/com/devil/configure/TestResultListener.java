...
public class TestResultListener extends TestListenerAdapter{
	...
	public static Logger logger = Logger.getLogger(TestResultListener.class);
...
private void saveScreen(ITestResult tr, AppiumDriver<?> driver) {
